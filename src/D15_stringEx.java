...
public class D15_stringEx {
	...
	public static void main(String[] args) {
		...
		System.out.println(str);						// 위의 코딩으로 인해 str 의 기본 문장인 Hello World 1234567890 이 잘리진않았다.
		
		System.out.println(str.substring(0, 5));		// 5번 인덱스 포함 X
		...
		str = "apple / bananana / kiwi / lemon / orange ";
		...
		//3. indexOf : 원하는 문자의 인덱스를 반환(못찾는 경우 -1로 출력)
		...
		//12. endsWith : 지정된 문자로 끝나는지 검사 ( 확장자 체크할 때 사용한다.)
		str = "오늘할일.html";
