...
public class G12_MappingEx {
	...
	public static void main(String[] args) {
		...
		// 문자열을 콤마(,)로 분리해서 double 자료형으로 반환하여 매핑하기
		...
		// 문자열을 콤마(,)로 분리하여 int 자료형으로 변환하여 매핑하기
		...
		// asDoubleStream : IntStream, LongStream 을 DoubleStream으로 형변환 하는것
		// asLongStream : IntStream을 LongStream으로 형변환 하는것
		// boxed : 
		//			IntStream 				Stream<Integer>
		//			LongStream 				Stream<Long>
		//			DoubleStream 	각각 		Stream<Double>	 로 형변환 하는것
