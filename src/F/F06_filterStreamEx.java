...
public class F06_filterStreamEx {
	...
	public static void main(String[] args) {
		...
		try {
			File inFile = new File("D:/AWS JAVA CLASS/FileTest/testFile/test.txt");
			File outFile = new File("D:/AWS JAVA CLASS/FileTest/testFile/test_out.txt");
			
			// 필터 스트림은 대상이 노드 스트림을 대상
			// 노드 스트림								// 노드 스트림이 필터 스트림으로 내보내거나 받는다
