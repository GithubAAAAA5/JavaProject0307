...
public class C01_Class2 {
	...
	public static void main(String[] args) {
		...
		// 객체 생성 명령어
		// ClassName instanceName = new Constructor();		// 생성자는 클래스 이름과 같다.
		// 생성자의 역할은 멤버변수(속성) 초기화 혹은 클래스 구동을 위한 사전 동작을 구현한다.
		...
		// 클래스를 사용하는 이유는
		//	- 대량으로 코드를 반복 사용하는 경우에 사전에 룰을 만들어 사용하기 위해서 클래스를 사용한다.
		//	- 코드를 최소하여 작업 할 수 있다.
