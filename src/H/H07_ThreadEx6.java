...
public class H07_ThreadEx6 {
	...
	/*
	 *  [스레드 그룹]
	 *   스레드 그룹은 관련되어 있는 스레드 별로 그룹핑해서 다루기 위해 사용한다.
	 *   그룹 안에 또 다른 그룹을 생성하는 것도 가능하다.
	 *   보안상 이유로 자신과 하위 그룹을 변경할 수 있다. 하지만 다른 그룹은 불가능하다.
	 *   
	 *  [관련 메서드들]
	 ...
	 *   - getMaxPriority()					: 현재 그룹의 스레드가 가질 수 있는 최대 우선 순위값 리턴
	 *   - setMaxPriority(int priority)		: 최대 우선 순위값 결정
