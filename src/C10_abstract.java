 ...
 * 
 * 	# 의미
 * 	 - abstract 제한자는 아직 구현되지 않았다는 의미를 가진다.
...
// shape 를 부모로 하는 사각형(rectangle) 삼각형(triangle) 클래스를 만들어 보세요.
...
//		};													//여기까지 를 익명 클래스라고 한다.
		...
		Shape Triangle = new Triangle(2,9);
		System.out.println(" 삼각형의 넓이는 : " + Triangle.getArea());
		System.out.println(" 삼각형의 위치는 : " + Triangle.postion());	
		
		Shape Rectangle = new Rectangle(9,9);
		System.out.println(" 사각형의 넓이는 : " + Rectangle.getArea());
		System.out.println(" 사각형의 위치는 : " + Rectangle.postion());
	}
