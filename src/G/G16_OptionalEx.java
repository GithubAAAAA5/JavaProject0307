...
public class G16_OptionalEx {
	...
	/*
	 * 	집계 메서드
	 * 	 스트림 API 에서 요소들의 최소값, 최대값, 합계, 평균값 갯수 등을 구할수 있는 메서드를 제공하고 있음. 합계와 갯수를 구해주는 메서드 이외 Optional로 시작하는 타입으로 리턴.
	 */
	public static void main(String[] args) {
		...
		System.out.println("요소들 중 첫번째 값 : " + first.getAsInt());		// getasint 로 optional 안에 있는 int 값만 불러온다
		...
		//OptionalXXX, isPreseent() - 값이 존재하는지 여부 확인  값이 있으면 true , isEmpty()    값이 없으면 true
		...
		// Stream, IntStream, LongStream, DoubleStream 을 전달
