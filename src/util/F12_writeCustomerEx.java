...
public class F12_writeCustomerEx {
	...
	public static void main(String[] args) {
		...
		Customer cus1 = new Customer("홍길동", 'M', "hong@naver.com", 1598);
		Customer cus2 = new Customer("강감찬", 'M', "kang@naver.com", 888);
		Customer cus3 = new Customer("유관순", 'F', "yoo@naver.com", 1589);
