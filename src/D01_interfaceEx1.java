 ...
 *  - 인터페이스 내에 메서드는 모두 추상메서드이며 public abstract는 생략이 가능하다.
 *  - 인터페이스 내에 변수는 항상 public static final 이며 이 또한 생략이 가능하다.
 *  - 인터페이스는 구현하면 다중 상속과 같은 효과를 낼 수 있다.
 *  	(클래스는 상속을 여러개 받으면 어느 부모의 멤버를 상속받아야할지 결정할 수 없지만, 
 ...
 *  - 반드시 인터페이스 내에 모든 메서드를 구현해야 한다.
 *  
 */

interface ShapeInterface {
	
	// 인터페이스 변수는 public static fianl을 생략할 수 있고, 이는 상수이다.
...
public class D01_interfaceEx1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("rest's Area + " + ractangleI.getArea());
		System.out.println("rest's Area + " + triangleI.getArea());
