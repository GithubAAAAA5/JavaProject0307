...
class SuperAirplane extends Airplane2 {
	/*
	...
	public SuperAirplane(String name) {
		super(name);
	}
...
public class Quiz_240314_PM_anser {

	public static void main(String[] args) {
		
		// 비행기 SuperAirplane 
		SuperAirplane s1 = new SuperAirplane("스텔스");
		s1.takeOff();
		s1.fly();
		s1.flyMode = 1;
		s1.fly();
