...
//		}
//		
//		cash = p.getPrice();		//	구매에 관련된 코드 이다.
//		trunk[t_index++] = p;		//	구매를 하지 못하는 상황을 위에서 먼저 정해주었다.
//		
//		
//	}
//	
...
//	}
//	
//	private void clearCart()	{	//카트 비우기	(cart초기화)
...
//
//
//	// 상속 받은 클래스는 생성자에게 반드시 부모 생성자를 호출한다.
//	// (호출하지 않으면 기본타입으로 생략되어 있다.)
//
//	// 아무것도 적지 않은 생성자에는 super() 가 생략되어 있다.
//	// Product 라는 부모 클래스에는 기본 생성자가 없기 때문에
//	// super(int price) 타입을 가지는 생성자를 반드시 호출해야 한다.
//	
